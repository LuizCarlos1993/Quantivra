...
import { Settings, Save, Database, Clock, Wifi, Shield, ChevronDown } from "lucide-react";
...
export function SettingsPage() {
  ...
  const [selectedStation, setSelectedStation] = useState(accessibleStations[0] || "Estação REPLAN (Paulínia - SP)");
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <div className="relative">
                  ...
                  />
                  <div className="w-11 h-6 bg-gray-300 rounded-full peer peer-checked:bg-[#2C5F6F] transition-colors peer-focus:ring-2 peer-focus:ring-[#2C5F6F] peer-focus:ring-offset-2"></div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1.5">
                Tempo de armazenamento dos dados antes do arquivamento
              </p>
            </div>
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-2">
                Limite para Alerta de Anomalia
              </label>
              ...
              <p className="text-xs text-gray-500 mt-1.5">
                Número de leituras suspeitas antes de gerar alerta
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-3 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm font-semibold text-[#1a3d47]">09/02/2026 03:00</p>
          </div>
          <div className="p-3 bg-gray-50 rounded-lg">
