...
import { X, User, Mail, MapPin, Shield, Eye, Settings, CheckCircle } from 'lucide-react';
...
export function UserModal({ isOpen, onClose, onSubmit, editUser = null }: UserModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!name || !email || !unit || !profile || unit === '--- Selecione uma Unidade ---') {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-auto">
        {/* Header */}
        <div className="sticky top-0 bg-gradient-to-r from-[#1a3d47] to-[#2C5F6F] px-6 py-4 flex items-center justify-between border-b border-white/20">
              ...
              {profiles.map((prof) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Click indicator (não selecionado) */}
                    {!isSelected && (
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 md:col-span-1">
                ...
                <div className="relative">
                  ...
                  >
                    {units.map((u) => (
                      <option key={u} value={u} disabled={u.startsWith('---')}>
                        {u}
                      </option>
                    ))}
                  </select>
